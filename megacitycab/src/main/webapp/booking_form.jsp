...
<%
    // Fetch vehicleNumber from the request parameter
    ...
    if (vehicleNumber != null) {
        try (Connection conn = DBConnect.getConnection();
            ...
            if (rs.next()) {
                ...
                veh.setV_seat(rs.getString("v_seat"));  // Ensure v_seat is VARCHAR in DB
                ...
                System.out.println("❌ Vehicle not found in DB for number: " + vehicleNumber);
            }
        ...
        System.out.println("❌ No vehicleNumber provided in request!");
    }
...
<body>
    ...
    <section class="booking-container">
        ...
        <form action="bookVehicle" method="post">
            ...
            <input type="text" id="customerName" name="customerName" value="${loggedInCustomer.c_name}" required>

            <label for="customerEmail">Email:</label>
            <input type="email" id="customerEmail" name="customerEmail" value="${loggedInCustomer.c_email}" required>

            <label for="customerPhone">Phone Number:</label>
            <input type="text" id="customerPhone" name="customerPhone" value="${loggedInCustomer.c_phone}" required>
